                ...
                <div class="modal-body p-4 p-lg-5">
                    <div class="d-flex justify-content-between align-items-start mb-4">
                        <div>
                            ...
                            <h3 class="display-6 fw-bold mt-3 mb-2">{{ $issuance->title }}</h3>
                    ...
                    <div class="issuance-modal-card">
                        @if ($isPdfPreview)
                            <iframe class="issuance-preview-frame" src="{{ $issuance->url }}" title="{{ $issuance->title }}"></iframe>
                        @elseif ($isImagePreview)
                            <img class="issuance-preview-image" src="{{ $issuance->url }}" alt="{{ $issuance->title }}">
                        @else
