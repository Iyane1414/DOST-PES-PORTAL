<section class="issuance-stop-shell" id="issuance-stop-shell">
    <div class="issuance-stop-stage" id="issuance-stop-stage">
            ...
            <div class="container">
                <div class="issuance-shell">
                    <div class="section-header d-flex flex-column flex-xl-row justify-content-between align-items-xl-end gap-3 position-relative">
                        ...
                        <form class="row g-2 align-items-center issuance-filters" id="issuance-filters" method="GET" action="{{ route('portal.home') }}" data-issuance-form>
                            <div class="col-12 col-md-auto">
                                <div class="issuance-search-wrap">
                                    <i class="bi bi-search"></i>
                                    <input class="form-control rounded-pill px-4 issuance-search" id="issuance-search" type="search" name="search" value="{{ $search }}" placeholder="Search issuances..." autocomplete="off" data-issuance-search>
                                </div>
                            </div>
                            <div class="col-6 col-md-auto">
                                <select class="form-select rounded-pill px-4 issuance-select issuance-select-accent" id="issuance-category" name="category" data-issuance-category>
                            ...
                            <div class="col-6 col-md-auto">
                                <button class="btn issuance-filter-btn rounded-pill px-4 w-100" type="button" data-issuance-apply>Filter by <i class="bi bi-chevron-down ms-2"></i></button>
                            </div>
                        </form>
                    </div>
                                    ...
                                    @forelse ($filteredIssuances as $issuance)
                                        @php
                                            $searchText = strtolower(implode(' ', array_filter([
                                                ...
                                                $issuance->category,
                                                $issuance->division,
                                                optional($issuance->date)->format('F d, Y'),
                                                optional($issuance->date)->format('Y-m-d'),
                                            ])));
                                        @endphp
